  ...
  <div class="white_shd full margin_bottom_30">
      <div class="table_section padding_infor_info">
          <div class="table-responsive-lg">
            <table class="table table-bordered table-striped table-sm" id="admin_loan">
                <thead>
                <tr>
                    <th>Last Name</th>
                    <th>First Name</th>
    ...
    @if ($l->TypeOfLoan === 'express' || $l->TypeOfLoan === 'lad')
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
           <div class="modal-content">
              ...
              <!-- Modal body -->
              <form action="{{ route('loan_app.update', $l->LOAN_ID) }}" method="POST">
                  @csrf

                  @method('PUT')
                  <input type="hidden" value="2" name="loan_status">
              ...
              <div class="modal-footer">
                  <button type="submit" class="btn btn-success mb-4 mt-4">Approved</button>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
           <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <input  type="hidden" value="2" name="loanApp_type">
