    ...
    @if ($l->TypeOfLoan === 'express' || $l->TypeOfLoan === 'lad')
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
           <div class="modal-content">
              ...
              <!-- Modal body -->
              <form action="{{ route('approved-loans.update', $l->LOAN_ID) }}" method="POST">
                  @csrf

                  @method('PUT')
                  <input type="hidden" value="4" name="loan_status">
              ...
              <div class="modal-footer">
                  <button type="submit" class="btn btn-success mb-4 mt-4">Settled</button>
