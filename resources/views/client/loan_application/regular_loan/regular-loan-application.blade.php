...
@section('title', 'Regular Loan Application Form')
@section('client_content')

<div class="h-100 d-flex align-items-center justify-content-center">
    <div class="mem-bg">
        <form action="{{ url('/regular-loan-application') }}" method="POST" enctype="multipart/form-data" class="this-form">
            <div class="content-form-page">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <small>Co-maker History</small><span class="text-danger"><small> (For Associate Member Only)</small></span>
                                <input type="text" name="co_history" class="form-control" placeholder="ENTER CO-MAKER HISTORY">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <small>Name of Co-maker</small><span class="text-danger"><small> (For Associate Member Only)</small></span>
