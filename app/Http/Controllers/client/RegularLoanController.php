...
class RegularLoanController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('client.loan_application.regular_loan.regular-loan-application', compact(['loan', 'years']));
        }
        return view('client.loan_application.regular_loan.regular-loan-application');
    }
